...
export const DatePickerPopover: React.FC<DatePickerPopoverProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-slate-900/60 dark:bg-slate-950/80 backdrop-blur-md animate-fade-in">
      <div
        className="w-full max-w-md bg-white dark:bg-slate-900 rounded-3xl p-4 sm:p-7 border border-slate-200 dark:border-slate-800 shadow-2xl relative animate-scale-in"
